namespace AXAMansard.Framework.NHibernateManager
{
    using NHibernate;
    ...
    using AXAMansard.Framework.NHibernateManager.Configuration;
    using System;
    using System.Linq;
    ...
    public sealed class NHibernateSessionManager
    {
        ...
        {
            this.InitSessionFactory(out cfg);
            try
            {
                this.ConfigureDB(cfg);
            }
            catch
            {
            }            
        ...
        private void InitSessionFactory(out NHibernate.Cfg.Configuration cfg)
        {
            ...
            this.sessionFactory.Add("", Fluently.Configure(cfg).Mappings(m => m.FluentMappings.AddFromAssembly(Assembly.Load(ConfigurationManager.AppSettings["MappingAssembly"]))).BuildSessionFactory());
        }
        ...
        public void ConfigureDB(NHibernate.Cfg.Configuration cfg)
        {
